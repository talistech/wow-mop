...
-- Racial onboarding variants. The legacy data only wired Stormwind and
-- Orgrimmar; the other race-local trainers were missing their training,
-- healing, level-up, and capture quest start/end rows.
INSERT IGNORE INTO creature_queststarter (id, quest) VALUES
