...
- On The Mend adds a temporary heal gossip option to the race-local stable masters when any related heal objective is incomplete.
...
Additional validation for the full questline pass:

- Racial onboarding variants are wired for Grady Bannson, Valeena, Lehna, Narzak, Naleen, Ansel Fincap, Jarson Everlong, Matty, Varzok, and Audrey Burnhep.
- Zonya's early Horde handoff ends quest `31815` at Zonya and quest `31817` at Merda.
